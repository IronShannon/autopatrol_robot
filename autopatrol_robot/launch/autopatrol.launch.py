...
def generate_launch_description():
    ...
    action_node_autopatrol_robot = launch_ros.actions.Node(
        package='autopatrol_robot',
        executable='patrol_node',
        parameters=[patrol_config_path]
    )
    
    action_node_patrol_speech_client = launch_ros.actions.Node(
        package='autopatrol_robot',
        executable='speaker',
    )
    
    return launch.LaunchDescription([
        action_node_autopatrol_robot,
        action_node_patrol_speech_client,
    ])