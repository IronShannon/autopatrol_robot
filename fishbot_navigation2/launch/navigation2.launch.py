...
def generate_launch_description():
    ...
    map_yalm_path = launch.substitutions.LaunchConfiguration('map', default=os.path.join(fishbot_navigation2_dir, 'maps', 'room.yaml'))
    ...
    return launch.LaunchDescription([
        ...
        launch.actions.DeclareLaunchArgument(
            'map', default_value=map_yalm_path,
            description='Full path to map file to load',
        ),
        launch.actions.DeclareLaunchArgument(
            'params_file', default_value=nav2_param_path,
            description='Full path to the param file to load',
        ),
